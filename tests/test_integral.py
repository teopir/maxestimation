...
class TestIntegralMethods(unittest.TestCase):
    ...
    def test_productIntegral(self):
        ...
        self.assertTrue(np.isclose(int_v,true_v))
        ...
        true_v = 0.432756
        self.assertTrue(np.isclose(int_v,true_v), msg='{} != {}'.format(int_v, true_v))
    ...
    def test_prod_int_div_cdf(self):
        ...
        pi_true = 0.00159266
        self.assertTrue(np.isclose(pi_hat, pi_true), msg='{} != {}'.format(pi_hat, pi_true))
        ...
        v_true = pi_hat/cdf
        self.assertTrue(np.isclose(v_hat, v_true))
